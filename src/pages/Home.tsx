    ...
    <div >
      ...
      <div className="row featurette feature" style={{ width: '70%', maxWidth: '1200px', margin: 'auto', display: 'flex', alignItems: 'center' }}>
        <div className="col-md-7">
          ...
          <p className="lead">Hometown Hoops was founded by Derek Bedal who saw a need
            for more opportunities to play basketball in the Leamington and surrounding areas.
            His idea started with a tournament in 2021. This idea then grew to not only host tournaments
            but to also include a recreational summer league for young adults the next summer.
            Derek plans to grow his business to include skill development camps for elementary
            and high school age players. Derek’s love of basketball began as a young boy and
            grew as he competed on multiple levels in high school. During this time he spent many
            summers attending various basketball camps such as PGC, Breakthrough Basketball, and others.
            Derek attended these camps to constantly grow his basketball IQ and his basketball skills.
            He hopes his love of the game will spread throughout the local communities as he provides multiple opportunities.</p>
        </div>
        <div className="col-md-5">
          <img className="shadow-sm bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" style={{ minHeight: '500px', objectFit: 'cover' }} height="500" role="img" src='src/assets/portrait.jpg' ></img>
        </div>
      </div>
      ...
      <h2 style={{ textAlign: 'center' }}>Our Sponsor's</h2>
      <p className="text-body-secondary" style={{ textAlign: 'center' }}>We are incredibly grateful for the support of our sponsor's that help make Hometown Hoops a success.</p>
